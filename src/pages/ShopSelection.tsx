...
const ShopSelection: React.FC = () => {
  ...
  const markets = useSelector<RootState>((state) => state.firestore) as FirestoreReducer.Reducer;
    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        {loading ? (
          ...
          <>
            {marketList.length > 0 ? (
              <ShopSelectionList handleShopClick={handleShopClick} shops={marketList} />
            ) : (
